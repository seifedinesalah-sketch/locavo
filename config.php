...
/*
   ...
   Fichier : suv.php
   Description : Page dynamique – catégorie SUV & Crossovers
*/
...
<head>
    ...
    <title>Locavo - SUV &amp; Crossovers</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="../php/suv.php" class="active">SUV &amp; Crossovers</a></li>
    ...
    <header class="suv-hero" style="background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/hero-home.jpg'); background-size: cover; background-position: center;">
        <h1>SUV &amp; Crossovers</h1>
    </header>

    <main class="container">
        <p style="text-align: center; color: #555; margin-bottom: 30px;">Puissance, confort et polyvalence pour toutes vos aventures.</p>

        <?php if (empty($voitures)): ?>
            <p style="text-align:center; color:#888;">Aucun SUV disponible pour le moment.</p>
        <?php else: ?>
        <div class="grid-3">
    ...
    <section class="cta-section">
        ...
        <p>Réservez votre SUV pour explorer sans limites.</p>
