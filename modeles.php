...
/*
   ...
   Fichier : economiques.php
   Description : Page dynamique – catégorie Voitures Économiques
*/
require_once '../config.php';

$stmt = $pdo->prepare("SELECT * FROM voitures WHERE categorie = ? ORDER BY prix_jour ASC");
$stmt->execute(['economique']);
...
<head>
    ...
    <title>Locavo - Voitures Économiques</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="../php/economiques.php" class="active">Économiques</a></li>
    ...
    <header class="eco-hero" style="background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/hero-home.jpg'); background-size: cover; background-position: center;">
        <h1>Voitures Économiques</h1>
    </header>

    <main class="container">
        <p style="text-align: center; color: #555; margin-bottom: 30px;">Des véhicules fiables et économiques pour vos trajets quotidiens.</p>

        <?php if (empty($voitures)): ?>
            <p style="text-align:center; color:#888;">Aucun véhicule économique disponible pour le moment.</p>
        <?php else: ?>
        <div class="grid-3">
    ...
    <section class="cta-section">
        <h2>Économisez sans compromis</h2>
        <p>Nos véhicules économiques allient confort et petits prix.</p>
