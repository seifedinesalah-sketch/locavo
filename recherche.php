...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="../php/modeles.php" class="active">Cabriolets</a></li>
    ...
    <header class="cabrio-hero" style="background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/hero-home.jpg'); background-size: cover; background-position: center;">
        <h1>Cabriolets</h1>
    </header>

    <main class="container">
        <p style="text-align: center; color: #555; margin-bottom: 30px;">Découvrez notre sélection de cabriolets pour profiter du soleil en toute liberté.</p>

        <?php if (empty($voitures)): ?>
            <p style="text-align:center; color:#888;">Aucun cabriolet disponible pour le moment.</p>
        <?php else: ?>
        <div class="grid-3">
    ...
    <section class="cta-section">
        <h2>Envie de sentir le vent dans vos cheveux ?</h2>
        <p>Réservez votre cabriolet dès maintenant.</p>
        <a href="../php/reservation.php" class="btn-white">Réserver</a>
    </section>
